...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
       ...
       $mail->addAddress($address);
          ...
          echo "<h1 style='color: #333; font-size: 24px;'>Le courriel a été envoyé avec succès.</h1>";
          echo "<p style='color: #666; font-size: 16px; margin-bottom: 20px;'>Merci <strong>$first_name</strong>, votre message a été envoyé avec succès.</p>";          
          echo "</div>";
          echo "</fieldset>";
      } catch (Exception $e) {
