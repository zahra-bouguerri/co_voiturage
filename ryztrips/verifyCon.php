...
if (isset($_GET['email'])) {
    ...
    if (isset($_POST['verify'])) {
        ...
        $sql = "SELECT * FROM conducteur WHERE adresse_conducteur=? AND verification_token=?";
        ...
        if ($result->num_rows == 1) {
            ...
            $sql = "UPDATE conducteur SET is_verified=1, verification_token=NULL WHERE adresse_conducteur=?";
            $stmt = $conn->prepare($sql);
